#' @title Bayesian inference for spatial generalized functional linear mixed model (SGFLMM)
#'
#' @description 
...
#' 
#' @export
posterior_samples_sgflmm <- function(M, initial, proposal_var_fixed, proposal_var_sigma2, proposal_var_rand, autotune, 
